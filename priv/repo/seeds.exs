...
Enum.each(
  [
    ...
    %{
      ...
      completed_date: nil,
      description:
        "multi label query still exists in Tasks context but was commented out to allow for dynamic query implementation. ",
    ...
    %{
      ...
      due_date: ~U[2021-02-22 16:42:00Z],
      id: 15,
      ...
      list_id: nil,
      priority: "Low",
      start_date: ~U[2021-02-22 16:42:00Z],
